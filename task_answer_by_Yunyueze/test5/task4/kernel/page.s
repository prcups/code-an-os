...
#线性空间中 kernel StartFrom 0x0            task1 StartFrom 0x5000000 线性页号0x5000(高10位0x14 低10位0x0)   task2 StartFrom 0x9000000 线页号0x9000(高10位 0x24 低10位0x0)              
...
setup_paging:
    ...
    movl  $0x2007, pg_dir+0x14*4        #页目录第20项 指向0x2000 task1页表的起始页号 7->(111) 用户态 内核态可访问 可读写 有效    
    movl  $0x3007, pg_dir+0x24*4        #页目录第36项 指向0x3000 task2页表的起始页号 7->(111) 用户态 内核态可访问 可读写 有效
