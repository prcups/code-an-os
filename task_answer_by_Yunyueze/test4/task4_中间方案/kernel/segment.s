...
ldt1:
    .quad 0x0040fa008e0001ff #task1 代码段(读/执行)0x8e00开始 长度512 DPL=3用户态
    .quad 0x0040f2008e0001ff #task1 数据段(读/写)0x8e00开始 长度512 DPL=3用户态
ldt1_end:

ldt2:
    .quad 0x0040fa00900001ff#task2 代码段(读/执行)0x9000开始 长度512 DPL=3用户态
    .quad 0x0040f200900001ff#task2 代码段(读/执行)0x9000开始 长度512 DPL=3用户态
ldt2_end:
