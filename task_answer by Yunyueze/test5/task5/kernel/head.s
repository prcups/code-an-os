    .globl pg_dir, pg_kernel, pg_task1, pg_task2,pg_task3,pg_task4
kernel_start:
...
go:
    ...
    jmp   after_page_tables     #调到6号页处的代码位置
    .org  0x1000                #填充0占位
pg_kernel: #1号页
    .org  0x2000 
pg_task1:  #2号页
...
move_to_user:                  #切换到用户态开始执行task1
    ...
    pushl $0x1000
    pushf
    pushl $0x07  #(0_111)ldt1中的代码段选择符  (cs)
    pushl $0
