...
as -g --32 -o page.o kernel/page.s
...
ld -m elf_i386 -Ttext=0 -o kernel.tmp head.o interrupt.o segment.o system_call.o task.o page.o display.o 8259A.o 8253.o keyboard.o
...
# 汇编、链接task3.bin
as --32 -o task3.o user_task/task3.s
ld -m elf_i386 --oformat binary -Ttext=0 -o task3.bin task3.o

# 汇编、链接task4.bin
as --32 -o task4.o user_task/task4.s
ld -m elf_i386 --oformat binary -Ttext=0 -o task4.bin task4.o
...
dd if=task1.bin of=../c.img bs=512 seek=61 conv=notrunc
dd if=task2.bin of=../c.img bs=512 seek=62 conv=notrunc
dd if=task3.bin of=../c.img bs=512 seek=63 conv=notrunc
dd if=task4.bin of=../c.img bs=512 seek=64 conv=notrunc
